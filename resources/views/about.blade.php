...
<header class="w-full text-sm mb-6">
    <nav class="flex justify-between items-center p-6 bg-black/95 backdrop-blur-sm border-b border-yellow-400/20 shadow-lg">
        <div class="text-2xl font-extrabold text-yellow-400">Vault X</div>
...
<section class="bg-gradient-to-b from-slate-950 via-slate-900 to-black py-28">
    <div class="max-w-5xl mx-auto px-6 text-center">
        ...
        <p class="mx-auto max-w-3xl text-lg text-gray-400 leading-relaxed">Vault X brings structure, discipline, and transparency to digital investing. We design every service around security, governance, and measurable performance so investors can move with confidence.</p>
    </div>
</section>
...
<section class="py-24 border-t border-gray-800">
    <div class="max-w-6xl mx-auto px-6 grid gap-16 lg:grid-cols-2">
        <div class="space-y-6">
            ...
            <p class="text-gray-300 leading-relaxed text-lg">Vault X exists to close the gap between emerging digital markets and proven investment standards. We help investors access crypto opportunities without sacrificing the controls, transparency, and risk management that matter most.</p>
...
<section class="py-20 border-t border-gray-800">
    <div class="max-w-4xl mx-auto px-6 text-gray-500 text-sm leading-relaxed">
        <p><strong>Risk Disclosure:</strong> Investing in digital assets involves risk, including possible loss of capital. Vault X does not guarantee returns. Past performance is not a reliable indicator of future results. Investors should evaluate their objectives and consult qualified advisors before investing.</p>
    </div>
</section>
